...
const MedicationForm: React.FC<MedicationFormProps> = ({ onSave }) => {
  ...
  return (
    <Flex height="50vh" w="30%" flexFlow="column" align="center" justify="center">
      ...
      {medication.times.map((time, index) => (
        <Box marginTop="10px" key={index} zIndex={1000} w="500px">
      ...
      <Flex w="80%">
        {medication.times.length ? <Button mt={4} colorScheme="blue" onClick={handleSave}>Save</Button> : null}
